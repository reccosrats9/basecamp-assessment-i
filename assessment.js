...
// #7 Create an if statement that checks the age variable below. If age is greater than 16, then set canDrive to true otherwise set canDrive 
//to false. The canDrive variable will be set by the unit test so do not adjust it.
var age = 18;
var canDrive;


if (age> 16){canDrive= true}
else canDrive= false;// CODE HERE
...
//If the param value is 'red' set reponse variable to 'I heart red'. Otherwise set the colorResponse variable to 'What is your favorite 
//color?'. Make sure to return the colorResponse variable at the end once it has been properly set.
...
// #9 Create a function called 'sum' that takes in one parameter and returns the sum of that parameter added to itself.
...
// #10 Create a function called 'greeter' that takes in two parameters, name and number. Have 'greeter' return a string that says something 
//like this 'Hi! I am Bryan and I am 28 years old" but with the appropriate values..
